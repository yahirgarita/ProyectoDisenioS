...
public class SMS {
    ...
    private static final String AUTH_TOKEN = "d60dc8f79cd9f02d67c392b832cda277"; 
    ...
    public static String enviarSMS(String destinario) { 
        ...
        Message message = Message.creator(new PhoneNumber("+506" + destinario), new PhoneNumber("+19704504353"), palabraMsgTel).create();
