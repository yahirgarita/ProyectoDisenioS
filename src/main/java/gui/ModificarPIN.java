 ...
 * @version 1.0
 */
public class ModificarPIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        nombreRegistro.setText("Digite el nuevo pin que desea");
        ...
        nombreRegistro1.setText("Ingrese el pin actual de la cuenta");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarPIN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarPIN().setVisible(true);
            }
        });
    }
