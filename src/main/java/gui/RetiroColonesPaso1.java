 ...
 * @author yahir
 */
public class RetiroColonesPaso1 extends javax.swing.JFrame {

    /**
     * Creates new form RetiroColonesPaso1
     */
    public RetiroColonesPaso1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RetiroColonesPaso1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RetiroColonesPaso1().setVisible(true);
            }
        });
    }
